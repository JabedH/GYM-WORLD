  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        the best It company. Now I Know many technologies <span> HTML5</span>{" "}
        <span>CSS3 </span> , <span>Bootstrap</span> , <span>Javascript</span> ,
        <span>React JS</span> and <span>Tailwind css</span>
      </p>
    </div>
  );
};
